<?php
class Phergie_Plugin_CB_Op extends Phergie_Plugin_Abstract
{
    ...
    public function onCommandOp($user = null)
    {
        $event = $this->getEvent();
	...
	public function onCommandDeop($user = null)
    {
        $event = $this->getEvent();
		$source = $event->getSource();
		$nick = $event->getNick();
